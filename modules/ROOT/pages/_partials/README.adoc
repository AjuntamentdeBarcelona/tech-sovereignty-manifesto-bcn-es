...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/tech-sovereignty-manifesto-bcn-es
//
// MANDATORY.
:_url: https://barcelona.cat/digitalstandards/es/manifesto/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Manifiesto a favor de la soberanía tecnológica y de los derechos digitales de las ciudades
//
...
:_summary: Manifiesto a favor de la soberanía tecnológica y de los derechos digitales de las ciudades.
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: manifiesto, estándares digitales éticos, derechos digitales, soberania tecnológica, ayuntamiento, barcelona
//
